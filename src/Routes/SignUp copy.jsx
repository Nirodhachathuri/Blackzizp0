...
const SignUp = () => {
  ...
  const handleFormSubmit = async (values) => {
    ...
    formData.append("image", selectedFiles); // Make sure selectedFiles is correctly populated

    console.log("FormData contents:", formData);

    try {
      const response = await axios.post(`${env_data.base_url}/register`, {
        formData,
        headers: {
